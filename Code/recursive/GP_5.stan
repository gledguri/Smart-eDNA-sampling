...
model {
  ...
  for (d in 1:N_depths) {
    ...
    gp_marginal_lp(X_d, y_d, alpha, real_rho, sigma, mu[d]);
  }
}
...
generated quantities {
  ...
  for (d in 1:N_depths_pred) {
    ...
    y_pred[start_p:end_p] = gp_predict_depth(N_d, N_d_p, X_d, y_d, X_d_pred, alpha, real_rho, sigma, mu[d]);
  }
}
